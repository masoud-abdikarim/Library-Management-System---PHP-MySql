<?php
// PHP CLI utility to fix signup.php head and styling
$root = dirname(__DIR__, 2);
$filePath = $root . '/php/signup.php';

if (!file_exists($filePath)) {
    die("Error: signup.php not found at {$filePath}\n");
}
...
echo "signup.php successfully updated!\n";
?>
