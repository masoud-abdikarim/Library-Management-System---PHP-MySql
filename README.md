...
Hi!, welcome to my repository. The **NEW HARGEISA LIBRARY (LMS)** is developed for transforming manual offline workload into online automatic system. It contains all the main 
...
Note: This is an extended version of NEW HARGEISA LIBRARY that can be found [here](https://phpgurukul.com/online-library-management-system/). I have added more advance functionalities like **report generation**.
